...
API_URL = "https://3x5wus0axd.execute-api.us-east-1.amazonaws.com/prod/vacationplanner01"
            ...
            with st.spinner("Planning your vacation..."):
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        st.json(body)  # Debug: inspect actual response structure
                        vacation_plan = body.get("agent_response", "Unable to retrieve vacation plan")
                        if isinstance(vacation_plan, dict):
                            st.json(vacation_plan)
                        else:
